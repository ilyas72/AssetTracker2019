...
$result = mysql_query("SELECT * FROM admin_tbl WHERE admin_id ORDER BY admin_id DESC");
?>
...
<center>
  ...
  <p><font size="+2">View Administrator</font></p>
	...
	<table cellpadding="3" cellspacing="4" width="100%">
		<tr bgcolor='#CCCCCC'>
			<td align="center" width="61">Name</td>
  ...
  <table border=0  cellpadding="3" cellspacing="4" width="100%">   
		...
		while($res = mysql_fetch_array($result)) {		
			echo "<tr>";
			echo "<td align='center' width='61'>".$res['name']."</td>";
			...
			echo "<td align='center' width='30'><a href=\"edit_admin.php?admin_id=$res[admin_id]\">Edit</a> | <a href=\"delete_admin.php?admin_id=$res[admin_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
		}
		?>
	</table>  	
   </div>
