...
<tr> 
    <td align="center"><h2><u>Ipad on loan</u></h2><br></td></tr>
     <tr> 
    <tr>
...
//query
    ...
    ?>
  <div><?php echo $row['ipad_name'];?><?php echo $row['name'];?></div>
    <?php	
    }
    ?></div></td>
      </tr>
...
?>
<form name="bulk_action_form" action="ipad_loan_delete.php" method="post" onsubmit="return validate(this)"/>
