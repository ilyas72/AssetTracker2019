...
<tr> 
    <td align="center">Ipad has been Loan</td></tr>
     <tr> 
    <tr>
		<td align="center"><div style='height:130px; width:780px; white-space: nowrap; overflow-x: visible; overflow-y: hidden;'><?php 
//db connection
...
//query
    ...
    ?>
  <input type="text" id="MyField" value="<?php echo $row['ipad_name'];?>" style="text-align:center; width:80px; height:102px; background-image:url(images/ipad-icon-loan.png); background-repeat:no-repeat;"/><input type="hidden" name="date_from" value="<?php echo $row['date_from'];?>, <?php echo $row['time_from'];?> | <?php echo $row['date_to'];?>, <?php echo $row['time_to'];?>"/>
    <?php	
    }
    ?></div></td>
      </tr>
