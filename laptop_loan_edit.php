...
{	
	$loan_laptop_id = $_POST['loan_laptop_id'];
	...
	if(empty($name) || empty($laptop_name) || empty($date_from) || empty($time_from) || empty($date_to) || empty($time_to)) {
		...
		//updating the table
		$result = mysql_query("UPDATE loan_laptop_tbl SET name='$name', laptop_name='$laptop_name', date_from='$date_from', time_from='$time_from', date_to='$date_to', time_to='$time_to' WHERE loan_laptop_id=$loan_laptop_id");
...
<?php
//getting id from url
$loan_laptop_id = $_GET['loan_laptop_id'];

//selecting data associated with this particular id
$result = mysql_query("SELECT * FROM loan_laptop_tbl WHERE loan_laptop_id=$loan_laptop_id");
...
<?php include("header.php"); ?>	
    ...
    <center>
		<table border="0" cellpadding="2" cellspacing="3" width="400">
            ...
            <tr> 
				<td>laptop no.</td>
				<td><input type="text" name="laptop_name" value=<?php echo $laptop_name;?> readonly></td>
			</tr>
            <tr> 
				<td>Date From</td>
			...
			<tr>
				<td><input type="hidden" name="loan_laptop_id" value=<?php echo $_GET['loan_laptop_id'];?>></td>
